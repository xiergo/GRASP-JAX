...
- **`distance_cutoff`**: Specifies the maximum allowed distance between the CB atoms of two residues (CA atom for glycine).
...
## Integrated modeling with Combfit
...
The output score.csv records the satisfaction for RPRs/IRs and density map.
